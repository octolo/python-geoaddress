...
def list_providers(request: HttpRequest) -> HttpResponse:
    ...
    # HTML format (default)
    return render(request, "django_geoaddress/provider_list.html", {"providers": result})
...
def detail_provider(request: HttpRequest, provider_name: str) -> HttpResponse:
    ...
    return render(request, "django_geoaddress/provider_detail.html", {"provider": provider})
