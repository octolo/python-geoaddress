...
def index(request: HttpRequest) -> HttpResponse:
    ...
    """
    context = {
        "providers_url": reverse("django_geoaddress:list_providers"),
        "suggest_url": reverse("django_geoaddress:search_addresses"),
    }
    return render(request, "django_geoaddress/index.html", context)
