...
GEOADDRESS_FIELDS_ESSENTIALS = {
    ...
    "state": {
        "label": "State/region/province or administrative area",
...
GEOADDRESS_FIELDS_OPTIONALS = {
    "organization": {
        "label": "Company, institution, or organization name",
    ...
    "locality": {
        "label": "Locality, hamlet or isolated dwelling",
        "description": "Small locality such as hamlet or isolated dwelling",
        "format": "str",
    },
    "state_code": {
        "label": "State/region/province or administrative area code",
        "description": "Standardized administrative subdivision code (ISO 3166-2)",
        "format": "str",
    },
    "po_box": {
        "label": "PO Box",
